...
import { GroupErrors, GroupResponse, GroupsCreatePayload, GroupsUpdatePayload } from "@sdk";
...
export const GroupForm : FunctionComponent<IGroupFormProps> = ({ group, errors, onSubmit }) => {
  ...
  return <Form action={handleSubmit}>
    <Form.Group className="mb-3" controlId="name">
      ...
      <Form.Control type="text" name="name" placeholder="Name" defaultValue={group.name} isInvalid={!!errors?.name} />
