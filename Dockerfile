...
# docker build -t authr .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name authr authr
...
ENTRYPOINT ["/authr/bin/docker-entrypoint"]
